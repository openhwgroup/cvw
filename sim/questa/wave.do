...
add wave -noupdate -expand -group lsu -expand -group dcache /testbench/dut/core/lsu/bus/dcache/dcache/FlushStage
...
add wave -noupdate -expand -group lsu -expand -group ptwalker /testbench/dut/core/lsu/ReadDataM
add wave -noupdate -expand -group lsu -expand -group ptwalker /testbench/dut/core/lsu/hptw/hptw/HPTWRW
...
add wave -noupdate /testbench/dut/core/priv/priv/trap/CommittedF
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 4} {3636 ns} 0} {{Cursor 4} {787447 ns} 1} {{Cursor 3} {710675 ns} 1} {{Cursor 4} {223860 ns} 1}
...
update
WaveRestoreZoom {3524 ns} {3788 ns}
