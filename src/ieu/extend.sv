...
module extend import cvw::*;  #(parameter cvw_t P) (
  ...
  always_comb
    case (ImmSrcD)
      ...
      // Zero immediate: store conditional / CMO offset, and the value Zimop MOPs write to rd
      3'b101:  if (P.ZALRSC_SUPPORTED | P.ZAAMO_SUPPORTED | P.ZICBOM_SUPPORTED | P.ZICBOZ_SUPPORTED | P.ZIMOP_SUPPORTED) ImmExtD = '0;
