...
set_property IOSTANDARD LVCMOS33 [get_ports south_resetn]

# Clock constraints
create_clock -period 20.000 -name clk_50m [get_ports default_50mhz_clk]
# Internal DDR3/MIG clocks are generated by the Xilinx IP constraints; do not
# create clocks on internal signals such as sys_clk_i or clk_ref_i with get_ports.
...
set_input_delay -clock [get_clocks -of_objects [get_pins mmcm/clk_out3]] -min -add_delay 0.000 [get_ports {GPI[*]}]
set_input_delay -clock [get_clocks -of_objects [get_pins mmcm/clk_out3]] -max -add_delay 0.000 [get_ports {GPI[*]}]
...
set_output_delay -clock [get_clocks -of_objects [get_pins mmcm/clk_out3]] -min -add_delay 0.000 [get_ports {GPO[*]}]
set_output_delay -clock [get_clocks -of_objects [get_pins mmcm/clk_out3]] -max -add_delay 0.000 [get_ports {GPO[*]}]
...
set_input_delay -clock [get_clocks -of_objects [get_pins mmcm/clk_out3]] -min -add_delay 0.000 [get_ports UARTSin]
set_input_delay -clock [get_clocks -of_objects [get_pins mmcm/clk_out3]] -max -add_delay 0.000 [get_ports UARTSin]
set_output_delay -clock [get_clocks -of_objects [get_pins mmcm/clk_out3]] -min -add_delay 0.000 [get_ports UARTSout]
set_output_delay -clock [get_clocks -of_objects [get_pins mmcm/clk_out3]] -max -add_delay 0.000 [get_ports UARTSout]


##### reset #####
#************** reset is inverted
set_property -dict { PACKAGE_PIN V26   IOSTANDARD LVCMOS33 } [get_ports { south_resetn }]; # SW2 on the board
set_property -dict { PACKAGE_PIN U26   IOSTANDARD LVCMOS33 } [get_ports { resetn }]; # SW3 on the board

set_input_delay -clock [get_clocks -of_objects [get_pins mmcm/clk_out3]] -min -add_delay 2.000 [get_ports resetn]
set_input_delay -clock [get_clocks -of_objects [get_pins mmcm/clk_out3]] -max -add_delay 2.000 [get_ports resetn]
set_max_delay -from [get_ports resetn] 20.000
set_false_path -from [get_ports resetn]

set_input_delay -clock [get_clocks -of_objects [get_pins mmcm/clk_out3]] -min -add_delay 2.000 [get_ports south_resetn]
set_input_delay -clock [get_clocks -of_objects [get_pins mmcm/clk_out3]] -max -add_delay 2.000 [get_ports south_resetn]
set_max_delay -from [get_ports south_resetn] 20.000
set_false_path -from [get_ports south_resetn]

# DDR3 calibration-complete CDC
...
# DDR3 CS is hardwired in this board
