log_output build/log/WALLY-debug-03.log
debug_level 3
init
poll off
...
# Grab tests
set objdump_file "build/WALLY-debug-03.elf.objdump"
set test2_addr [get_address $objdump_file test2]
set write_data_addr [get_address $objdump_file write_data]
...
set_reg [list dpc $write_data_addr]
