...
//-----------------------------------------------------------------------
  ...
  #define FSREG fsw
  #define FREGWIDTH 4
#if FLEN==128 // Add support for quad precision (128-bit floating-point)
  #define FLREG flq  // Load quad precision
  #define FSREG fsq  // Store quad precision
  #define FREGWIDTH 16 // Quad precision register width
  #define SIGALIGN 16 // Alignment for quad precision
#endif
#endif
#endif
...
#if SIGALIGN==16
  #define CANARY \
      .quad 0x6F5CA309E7D4B2816F5CA309E7D4B281 // Specific 128-bit canary value
#elif SIGALIGN==8
  #define CANARY \
