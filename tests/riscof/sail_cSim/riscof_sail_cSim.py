...
class sail_cSim(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.sail_exe = {"32": os.path.join(config["PATH"] if "PATH" in config else "", "sail_riscv_sim"), "64": os.path.join(config["PATH"] if "PATH" in config else "", "sail_riscv_sim")}
    ...
    def initialise(self, suite, work_dir, archtest_env):
        ...
        self.compile_cmd = (
            "riscv64-unknown-elf-gcc -march={0} -Wl,--no-warn-rwx-segments \
